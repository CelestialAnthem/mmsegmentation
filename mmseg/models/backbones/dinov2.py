...
class DINOv2(nn.Module):
    ...
    def __init__(self, version='large', freeze=False, load_from=None):
        ...
        if version == 'large':
            ...
            self.dinov2 = torch.hub.load('torchhub/facebookresearch_dinov2_main', 'dinov2_vitg14', source='local', pretrained=False)
        else:
        ...
        if load_from is not None:
            ...
            for key, value in d.items():
                ...
                # elif 'depth_head' in key:
                #     new_d[key.replace('depth_head.', '')] = value
                else:
                    new_d[key] = value
            print(new_d.keys())
